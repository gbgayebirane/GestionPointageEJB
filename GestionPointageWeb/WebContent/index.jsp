            ...
            <div class="container">
                ...
                <nav class="collapse navbar-collapse main-navbar" role="navigation">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown ">
                            <a href="Professeur" class="dropdown-toggle" data-toggle="dropdown">Liste</a>
        ...
        <section class="section swatch-white-red has-top">
                ...
                <div class="container">
                    <header class="section-header underline">
                        <h1 class="headline super hairline">Ajouter Professeurs</h1>
                    </header>
                    <div class="row-fluid">
                        <div class="span12">
                          <form  method="Post" action="Professeur"  class="contact-form">
                                <div class="form-group form-icon-group">
                                    <input class="form-control" id="name" name="nom" placeholder="Nom*" type="text" required/>
                                </div>
                                <div class="form-group form-icon-group">
                                    <input class="form-control" id="name" name="prenom" placeholder="Prenom *" type="text" required>
                                </div>
                                <div class="form-group form-icon-group">
                                    <input class="form-control" id="name" name="salaire" placeholder="Salaire*" type="text" required>
                                </div>
